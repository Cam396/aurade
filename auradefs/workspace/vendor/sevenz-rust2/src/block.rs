...
impl Coder {
    ...
    /// The coder's properties as the header carries them: for LZMA2 one
    /// byte that encodes the dictionary size.
    ///
    /// AuraDE: added over 0.19.4 so a test can read back the dictionary an
