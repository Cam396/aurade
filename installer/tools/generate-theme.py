...
/* One finding. Deliberately quieter than the verdict above it - five cards
   competing at the verdict's volume is five things shouting and nothing
   read. The state shows in the glyph and in a single edge, not in a fill. */
.aurade-check {
  background: @m3_surface_container_low;
  border-radius: 16px;
  border: 1px solid @m3_outline_variant;
...
.aurade-check-ok { border-left: 3px solid @m3_tertiary; }
.aurade-check-warn { border-left: 3px solid @m3_secondary; }
.aurade-check-blocked {
  border-left: 3px solid @m3_error;
