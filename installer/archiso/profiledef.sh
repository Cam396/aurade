...
file_permissions=(
  ...
  ["/usr/local/sbin/aurade-explain"]=0:0:755
  ["/usr/local/sbin/aurade-network-diagnostics"]=0:0:755
  ["/usr/local/sbin/aurade-refresh-mirrors"]=0:0:755
  ["/usr/local/bin/aurade-rate-sampler"]=0:0:755
  ["/usr/local/bin/aurade-first-boot-accessibility"]=0:0:755
  ...
  ["/usr/local/lib/aurade/aurade_gui/status.py"]=0:0:644
